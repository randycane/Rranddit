...
class PostForm(FlaskForm):
  post_title = StringField("post_title", validators=[DataRequired("Title is required!"), Length(min=3, max=200, message="Post title should be between 3 and 200 characters long")])
